...
QT_MOC_LITERAL(1, 20, 14), // "On_Resize_View"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "CDrawing_Tab_Widget\0On_Resize_View\0"
};
...
void CDrawing_Tab_Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->On_Resize_View(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject CDrawing_Tab_Widget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CDrawing_Tab_Widget.data,
